...
BlockchainDouble.prototype.createBlock = function(parent, callback) {
  ...
  getParent(function(err, parent) {
    ...
    var account = this.accounts[block.header.number % this.accounts.length].address
    ...
    block.header.signature = this.accounts[block.header.number % this.accounts.length].address
    */
    callback(null, block);
  });
};
